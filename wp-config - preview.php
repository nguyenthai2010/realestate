...
define('DB_NAME', 'taichinh_realestate');

/** MySQL database username */
define('DB_USER', 'taichinh_realest');

/** MySQL database password */
define('DB_PASSWORD', 'Z3WsAd4SGXNy');
...
define('WP_HOME','http://realestate.taichinh-24h.com/');
define('WP_SITEURL','http://realestate.taichinh-24h.com/');
